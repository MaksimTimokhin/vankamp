...
private:
    ...
    TerminatedStringIteratorRange TerminatedStringIds() const {
        return NodeReference::TerminatedStringIteratorRange(node_->terminated_string_ids.begin(),
...
private:
    ...
    static void AddString(TrieNode *root, size_t string_id, const std::string &string) {
